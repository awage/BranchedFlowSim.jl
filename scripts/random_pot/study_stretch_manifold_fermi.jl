...
# ax = Axis(fig[1,1], ylabel = L"x", xlabel = L"y", yticklabelsize = 20, xticklabelsize = 20, ylabelsize = 20, xlabelsize = 20,  titlesize = 20 )
# heatmap!(ax,ys,xs, log.(img .+ 1e-6))
# save("fermi_v0.1_panel_1.png",fig)
